    ...
    <section id="newsletter" className="py-16 bg-white border-y border-gray-200 px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-600 mb-8">
          Get insights on automation, AI, and business efficiency delivered to your inbox.
        </p>
        <form onSubmit={handleSubmit} className="max-w-md mx-auto">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="bg-primary text-white px-6 py-3 rounded-md font-semibold hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
