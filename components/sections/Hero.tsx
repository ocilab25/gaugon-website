      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mb-10 text-left bg-gray-50 p-6 rounded-lg border border-gray-100 dark:bg-gray-800/50 dark:border-gray-700">
              <p className="font-semibold text-gray-900 mb-3 text-center lg:text-left">In your free AI audit you will:</p>
              <ul className="grid sm:grid-cols-1 gap-4 text-gray-700">
