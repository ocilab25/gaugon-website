    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-gray-400 max-w-md">
              AI automation and IT solutions for growing businesses. Streamline operations, automate workflows, and scale efficiently.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/contact" className="hover:text-white transition-colors">Book Audit</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          <p>&copy; 2025 Gaugon. All rights reserved.</p>
